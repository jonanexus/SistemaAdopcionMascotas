<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffDashboard.aspx.cs" Inherits="SistemaAdopcionMascotas.StaffDashboard" %>
    ...
    <form id="form1" runat="server">
        <div class="container mt-4">
            <div class="card">
                ...
                <div class="card-body">
                    <asp:Menu ID="menuStaff" runat="server" CssClass="nav nav-pills flex-column">
                        <Items>
